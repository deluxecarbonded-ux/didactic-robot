/* ==========================================================================
   Exotic — icons
   Lucide path data, inlined so the game renders identically online and off.
   Every glyph inherits `currentColor`, which the theme sets to #ffffff in
   dark mode and #000000 in light mode.
   ========================================================================== */
(function (global) {
  "use strict";
  ...
  var P = {
    ...
    swords: '<path d="m7 21-4.3-4.3c-1-1-1-2.5 0-3.4l9.6-9.6c1-1 2.5-1 3.4 0l5.6 5.6c1 1 1 2.5 0 3.4L13 21"/><path d="M22 21h-6"/><path d="M2 11V5a2 2 0 0 1 2-2h6"/><path d="m15 12 4 4"/>',
    target: '<circle cx="12" cy="12" r="10"/><circle cx="12" cy="12" r="6"/><circle cx="12" cy="12" r="2"/>',
    crosshair: '<circle cx="12" cy="12" r="10"/><line x1="22" x2="18" y1="12" y2="12"/><line x1="6" x2="2" y1="12" y2="12"/><line x1="12" x2="12" y1="6" y2="2"/><line x1="12" x2="12" y1="22" y2="18"/>',
    dice: '<rect width="18" height="18" x="3" y="3" rx="2"/><path d="M8 8h.01"/><path d="M16 8h.01"/><path d="M8 16h.01"/><path d="M16 16h.01"/><path d="M12 12h.01"/>',
    ...
    pi: '<line x1="9" x2="9" y1="4" y2="20"/><path d="M15 4c-1.5 0-2 .5-2 2v14"/><path d="M3 4h18"/>',
    ...
    orbit2: '<circle cx="12" cy="12" r="3"/><circle cx="19" cy="5" r="2"/><circle cx="5" cy="19" r="2"/><path d="M10.4 21.9a10 10 0 0 0 9.941-15.416"/><path d="M13.5 2.1a10 10 0 0 0-9.841 15.416"/>',
    ...
    layers: '<path d="M12.83 2.18a2 2 0 0 0-1.66 0L2.6 6.08a1 1 0 0 0 0 1.83l8.58 3.91a2 2 0 0 0 1.66 0l8.58-3.9a1 1 0 0 0 0-1.83z"/><path d="m22 12.08-9.17 4.18a2 2 0 0 1-1.66 0L2 12.08"/><path d="m22 17.08-9.17 4.18a2 2 0 0 1-1.66 0L2 17.08"/>',
    ...
    clover: '<path d="M16.17 7.83 2 22"/><path d="M4.02 12a2.827 2.827 0 1 1 1.81-4.17A2.827 2.827 0 1 1 12 4.02a2.827 2.827 0 1 1 4.17 1.81A2.827 2.827 0 1 1 19.98 12a2.827 2.827 0 1 1-1.81 4.17A2.827 2.827 0 1 1 12 19.98a2.827 2.827 0 1 1-4.17-1.81A2.827 2.827 0 1 1 4.02 12"/><path d="M7.83 16.17 22 2"/>',
    ...
    hourglassOff: '<path d="M5 22h14"/><path d="M5 2h14"/>',
    bed: '<path d="M2 4v16"/><path d="M2 8h18a2 2 0 0 1 2 2v10"/><path d="M2 17h20"/><path d="M6 8v9"/>',
    egg: '<path d="M12 22c-4.97 0-9-3.582-9-8 0-4.418 4.03-12 9-12s9 7.582 9 12c0 4.418-4.03 8-9 8Z"/>'
  };
  ...
  function resolve(name) {
    ...
    if (ALIASES[name] && P[ALIASES[name]]) return ALIASES[name];
    var camel = String(name).replace(/[-_ ](.)/g, function (_, c) { return c.toUpperCase(); });
    if (P[camel]) return camel;
    if (ALIASES[camel] && P[ALIASES[camel]]) return ALIASES[camel];
    return null;
  }

  /**
   * Return an SVG markup string for a Lucide icon.
   * @param {string} name  icon key
   * @param {{size?:number, stroke?:number, className?:string, fill?:string}} [opts]
   */
  function icon(name, opts) {
    var o = opts || {};
    var key = resolve(name) || "help";
    var size = o.size || 20;
    var stroke = o.stroke == null ? 1.85 : o.stroke;
    var cls = "icon" + (o.className ? " " + o.className : "");
    return '<svg class="' + cls + '" xmlns="http://www.w3.org/2000/svg" width="' + size + '" height="' + size +
      '" viewBox="0 0 24 24" fill="' + (o.fill || "none") + '" stroke="currentColor" stroke-width="' + stroke +
      '" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false">' + P[key] + "</svg>";
  }

  /** DOM node variant. */
  function iconNode(name, opts) {
  ...
  /** Build a <button> whose whole body is an icon. */
  function iconButton(name, opts) {
    var o = opts || {};
    var btn = document.createElement("button");
    btn.type = "button";
    btn.className = "btn btn-icon" + (o.className ? " " + o.className : "");
    if (o.label) {
      btn.setAttribute("aria-label", o.label);
      btn.title = o.label;
    }
    btn.innerHTML = icon(name, { size: o.size || 18, stroke: o.stroke });
    return btn;
  }

  X.icons = { paths: P, icon: icon, node: iconNode, button: iconButton, names: Object.keys(P), has: function (n) { return !!resolve(n); } };
})(window);
